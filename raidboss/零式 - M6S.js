  ...
  triggers: [
    ...
    },
    {
      ...
      alertText: (data, matches, output) => {
        ...
        if (data.role === "tank") {
          if (data.soumaTankBuff === undefined) return output.first();
    ...
    },
    {
      ...
      promise: async (data) => {
        ...
        ).combatants.filter((v) => v.ID && data.soumaAddIds.includes(v.ID));
      ...
      infoText: (data, _matches, output) => {
        ...
        const maxSafeKey = Object.keys(safe).reduce((a, b) =>
          safe[a] > safe[b] ? a : b
        );
    ...
    },
    {
      ...
      condition: (data, matches) =>
        matches.duration === "43.00" && matches.target === data.me,
      preRun: (data, matches) => {

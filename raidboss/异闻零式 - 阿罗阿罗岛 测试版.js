...
Options.Triggers.push({
  id: 'SoumaAnotherAloaloIslandSavage',
  ...
  triggers: [
    ...
    {
      id: 'AAIS Souma Ketuduke Add1 Cleaner',
      type: 'AddedCombatant',
    ...
    {
      id: 'AAIS Souma Ketuduke Add2 Text',
      type: 'AddedCombatant',
      netRegex: { npcNameId: '12606', capture: true },
      delaySeconds: 0.5,
    ...
    {
      id: 'AAIS Souma Ketuduke Add2 Text2',
      type: 'AddedCombatant',
    ...
    {
      id: 'AAIS Souma Ketuduke Add2 Status',
      type: 'GainsEffect',
    ...
    {
      id: 'AAIS Souma Ketuduke Add2 Cleaner',
      type: 'AddedCombatant',
      netRegex: { npcNameId: '12606', capture: false },
      delaySeconds: 22,
      suppressSeconds: 1,
    ...
    {
      id: 'AAIS Souma Ketuduke Add1 Status',
      type: 'GainsEffect',
    ...
    // 2 8AB2 1麻顺时针
    {
      id: 'AAIS Souma Ketuduke Majiang',
    ...
    },
    {
      ...
      run: (data, matches) => data._lalaBossTimes = matches.id === '8BE0' ? 3 : 5,
    },
    {
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: '8CBF', capture: false },
      delaySeconds: (data) => {
    ...
    {
      id: 'AAIS Souma Statice Boom Tracker',
      type: 'SpawnNpcExtra',

...
Options.Triggers.push({
  ...
  triggers: [
    ...
    },
    {
      ...
      run: (data, matches) => data.soumaWeapon = ['A55D', 'A57F'].includes(matches.id) ? '棒' : '刀',
      outputStrings: {
        'A55D': { en: '稍后钢铁' },
        'A55E': { en: '稍后月环' },
        'A57F': { en: '稍后钢铁' },
    ...
    },
    {
      ...
      netRegex: { flags: '00020001', location: ['0D', '11', '05', '09', '1D', '21', '15', '19'] },
      suppressSeconds: 10,
    ...
    },
    {
      ...
      alertText: (data, matches, output) => {
        ...
        return output[`${weapon}${data.soumaP3转移Counter === 1 ? '1' : '2'}`]();
      },
      outputStrings: {
        '刀1': { en: '转移+月环 => AoE' },
        '刀2': { en: '转移+月环' },
    ...
    },
    {
      ...
      response: (data, _matches, output) => {
        ...
        return {
          [data.role === 'tank' ? 'alarmText' : 'infoText']: output[data.role](),
        };
      },
    },
    {
    ...
    },
    {
      ...
      type: 'HeadMarker',
      netRegex: { id: '01D2' },
      condition: (data, matches) => matches.target === data.me && data.soumaPhase === 'P3',
      alarmText: (_data, _atches, output) => output.text(),
